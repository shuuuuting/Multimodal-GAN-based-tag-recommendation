...
class DataGen(Sequence):
    ...
    def on_era_end(self): #重新抽globalset
	    G_out, GAN_out = gan.stacked_G_D.predict([image_train, embedding_train])
...
class GAN(object):
    ...
    def train(self, image_train, embedding_train, tag_train, epochs, batch_size):
        ...
        for e in range(epochs):
            ...
            acc_K, _, _, _ = evaluation(tag_train, self.G.predict(x=[image_train, embedding_train]), TopK) 
...
#precision:  0.1506172839506173
#recall:  0.6595748999188152
#f1:  0.23161837981526087
