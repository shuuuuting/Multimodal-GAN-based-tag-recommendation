        ...
        for e in range(epochs):
            ...
            for d_step in range(d_steps):
                ...
                for cnt in range(iters):
                    ...
                    x_combined_batch = np.append(np.append(intermediate_output[lwr:upr],real_tags[lwr:upr],axis=1), np.append(intermediate_output[lwr:upr],fake_tags,axis=1), axis=0)
