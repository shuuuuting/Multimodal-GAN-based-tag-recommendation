...
class DataGen(Sequence):
    def __init__(self, image_train, text_train, group_train, title_train, tag_train, tot_ex, batch_size):
...
#datagen = DataGen(image_train, text_train, group_train, title_train, tag_train, tot_ex=len(image_train), batch_size=64)
...
class GAN(object):
    ...
    def __generator(self):
        ...
        inputs_text = Input(shape=(seq_length, embedding_size)) #pretrain
    ...
    def train(self, image_train, text_train, group_train, title_train, tag_train, epochs, batch_size):
        dlist, glist = [], []
        global datagen
        ...
        for e in range(epochs):
            ...
            acc_K, _, _, _ = evaluation(tag_train, self.G.predict(x=[image_train, text_train, group_train, title_train]), TopK) 
...
batch_size = 64
gan = GAN(num_tags)
#d_history, g_history = gan.train(image_train, text_train, group_train, title_train, tag_train.astype(np.float32), epochs=epochs, batch_size=batch_size)
...
#%%
#y_pred = gan.G.predict(x=[image_test, text_test, group_test, title_test])
...
#i+t+g+e / no pretrain model
#acc:  0.8350970017636684
#precision:  0.163668430335097
#recall:  0.7267972621147224
#f1:  0.2524524429200335

#i(word2vec)+t+g+e / pretrain model
#acc:  0.7389770723104057
#precision:  0.14312169312169312
#recall:  0.613453570728703
#f1:  0.21911920325806347
#---g optimizer 'adam'
#acc:  0.7760141093474426
#precision:  0.15026455026455024
#recall:  0.653212396069539
#f1:  0.23087047809577174

#i(word2vec)+t+g+e / no pretrain model
#acc:  0.7557319223985891
#precision:  0.1462962962962963
#recall:  0.6342750062988158
#f1:  0.2244428425792784
#---g optimizer lr=0.001
#acc:  0.781305114638448
#precision:  0.15114638447971784
#recall:  0.6640453094818174
#f1:  0.23242536391380725
#---g optimizer 'adam'
#acc:  0.800705467372134
#precision:  0.1540564373897707
#recall:  0.6809068895047731
#f1:  0.23747018455050795