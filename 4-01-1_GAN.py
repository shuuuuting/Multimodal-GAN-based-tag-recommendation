...
datagen = DataGen(image_train, embedding_train, tag_train, tot_ex=len(image_train), batch_size=batch_size)
...
class GAN(object):
    def __init__(self, num_tags):
        ...
        self.stacked_G_D.compile(loss=[myLossFunc, 'BinaryCrossentropy'], optimizer=self.g_optimizer) #loss_weights = [0.8,0.2],
